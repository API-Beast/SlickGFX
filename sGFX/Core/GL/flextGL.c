/*
    This file was generated using https://github.com/mosra/flextgl:
        ...
        path/to/flextGLgen.py -D generated -t templates/glfw3 profile.txt
...
void flextLoadOpenGLFunctions(void) {
    ...
    /* GL_VERSION_4_2 */
    glpfBindImageTexture = (PFNGLBINDIMAGETEXTURE_PROC*)glfwGetProcAddress("glBindImageTexture");
    glpfDrawArraysInstancedBaseInstance = (PFNGLDRAWARRAYSINSTANCEDBASEINSTANCE_PROC*)glfwGetProcAddress("glDrawArraysInstancedBaseInstance");
    glpfDrawElementsInstancedBaseInstance = (PFNGLDRAWELEMENTSINSTANCEDBASEINSTANCE_PROC*)glfwGetProcAddress("glDrawElementsInstancedBaseInstance");
    glpfDrawElementsInstancedBaseVertexBaseInstance = (PFNGLDRAWELEMENTSINSTANCEDBASEVERTEXBASEINSTANCE_PROC*)glfwGetProcAddress("glDrawElementsInstancedBaseVertexBaseInstance");
    glpfDrawTransformFeedbackInstanced = (PFNGLDRAWTRANSFORMFEEDBACKINSTANCED_PROC*)glfwGetProcAddress("glDrawTransformFeedbackInstanced");
    glpfDrawTransformFeedbackStreamInstanced = (PFNGLDRAWTRANSFORMFEEDBACKSTREAMINSTANCED_PROC*)glfwGetProcAddress("glDrawTransformFeedbackStreamInstanced");
    glpfGetActiveAtomicCounterBufferiv = (PFNGLGETACTIVEATOMICCOUNTERBUFFERIV_PROC*)glfwGetProcAddress("glGetActiveAtomicCounterBufferiv");
    glpfGetInternalformativ = (PFNGLGETINTERNALFORMATIV_PROC*)glfwGetProcAddress("glGetInternalformativ");
    glpfMemoryBarrier = (PFNGLMEMORYBARRIER_PROC*)glfwGetProcAddress("glMemoryBarrier");
    glpfTexStorage1D = (PFNGLTEXSTORAGE1D_PROC*)glfwGetProcAddress("glTexStorage1D");
    glpfTexStorage2D = (PFNGLTEXSTORAGE2D_PROC*)glfwGetProcAddress("glTexStorage2D");
    glpfTexStorage3D = (PFNGLTEXSTORAGE3D_PROC*)glfwGetProcAddress("glTexStorage3D");

    /* GL_VERSION_4_3 */
    glpfBindVertexBuffer = (PFNGLBINDVERTEXBUFFER_PROC*)glfwGetProcAddress("glBindVertexBuffer");
    glpfClearBufferData = (PFNGLCLEARBUFFERDATA_PROC*)glfwGetProcAddress("glClearBufferData");
    glpfClearBufferSubData = (PFNGLCLEARBUFFERSUBDATA_PROC*)glfwGetProcAddress("glClearBufferSubData");
    glpfCopyImageSubData = (PFNGLCOPYIMAGESUBDATA_PROC*)glfwGetProcAddress("glCopyImageSubData");
    glpfDebugMessageCallback = (PFNGLDEBUGMESSAGECALLBACK_PROC*)glfwGetProcAddress("glDebugMessageCallback");
    glpfDebugMessageControl = (PFNGLDEBUGMESSAGECONTROL_PROC*)glfwGetProcAddress("glDebugMessageControl");
    glpfDebugMessageInsert = (PFNGLDEBUGMESSAGEINSERT_PROC*)glfwGetProcAddress("glDebugMessageInsert");
    glpfDispatchCompute = (PFNGLDISPATCHCOMPUTE_PROC*)glfwGetProcAddress("glDispatchCompute");
    glpfDispatchComputeIndirect = (PFNGLDISPATCHCOMPUTEINDIRECT_PROC*)glfwGetProcAddress("glDispatchComputeIndirect");
    glpfFramebufferParameteri = (PFNGLFRAMEBUFFERPARAMETERI_PROC*)glfwGetProcAddress("glFramebufferParameteri");
    glpfGetDebugMessageLog = (PFNGLGETDEBUGMESSAGELOG_PROC*)glfwGetProcAddress("glGetDebugMessageLog");
    glpfGetFramebufferParameteriv = (PFNGLGETFRAMEBUFFERPARAMETERIV_PROC*)glfwGetProcAddress("glGetFramebufferParameteriv");
    glpfGetInternalformati64v = (PFNGLGETINTERNALFORMATI64V_PROC*)glfwGetProcAddress("glGetInternalformati64v");
    glpfGetObjectLabel = (PFNGLGETOBJECTLABEL_PROC*)glfwGetProcAddress("glGetObjectLabel");
    glpfGetObjectPtrLabel = (PFNGLGETOBJECTPTRLABEL_PROC*)glfwGetProcAddress("glGetObjectPtrLabel");
    glpfGetPointerv = (PFNGLGETPOINTERV_PROC*)glfwGetProcAddress("glGetPointerv");
    glpfGetProgramInterfaceiv = (PFNGLGETPROGRAMINTERFACEIV_PROC*)glfwGetProcAddress("glGetProgramInterfaceiv");
    glpfGetProgramResourceIndex = (PFNGLGETPROGRAMRESOURCEINDEX_PROC*)glfwGetProcAddress("glGetProgramResourceIndex");
    glpfGetProgramResourceLocation = (PFNGLGETPROGRAMRESOURCELOCATION_PROC*)glfwGetProcAddress("glGetProgramResourceLocation");
    glpfGetProgramResourceLocationIndex = (PFNGLGETPROGRAMRESOURCELOCATIONINDEX_PROC*)glfwGetProcAddress("glGetProgramResourceLocationIndex");
    glpfGetProgramResourceName = (PFNGLGETPROGRAMRESOURCENAME_PROC*)glfwGetProcAddress("glGetProgramResourceName");
    glpfGetProgramResourceiv = (PFNGLGETPROGRAMRESOURCEIV_PROC*)glfwGetProcAddress("glGetProgramResourceiv");
    glpfInvalidateBufferData = (PFNGLINVALIDATEBUFFERDATA_PROC*)glfwGetProcAddress("glInvalidateBufferData");
    glpfInvalidateBufferSubData = (PFNGLINVALIDATEBUFFERSUBDATA_PROC*)glfwGetProcAddress("glInvalidateBufferSubData");
    glpfInvalidateFramebuffer = (PFNGLINVALIDATEFRAMEBUFFER_PROC*)glfwGetProcAddress("glInvalidateFramebuffer");
    glpfInvalidateSubFramebuffer = (PFNGLINVALIDATESUBFRAMEBUFFER_PROC*)glfwGetProcAddress("glInvalidateSubFramebuffer");
    glpfInvalidateTexImage = (PFNGLINVALIDATETEXIMAGE_PROC*)glfwGetProcAddress("glInvalidateTexImage");
    glpfInvalidateTexSubImage = (PFNGLINVALIDATETEXSUBIMAGE_PROC*)glfwGetProcAddress("glInvalidateTexSubImage");
    glpfMultiDrawArraysIndirect = (PFNGLMULTIDRAWARRAYSINDIRECT_PROC*)glfwGetProcAddress("glMultiDrawArraysIndirect");
    glpfMultiDrawElementsIndirect = (PFNGLMULTIDRAWELEMENTSINDIRECT_PROC*)glfwGetProcAddress("glMultiDrawElementsIndirect");
    glpfObjectLabel = (PFNGLOBJECTLABEL_PROC*)glfwGetProcAddress("glObjectLabel");
    glpfObjectPtrLabel = (PFNGLOBJECTPTRLABEL_PROC*)glfwGetProcAddress("glObjectPtrLabel");
    glpfPopDebugGroup = (PFNGLPOPDEBUGGROUP_PROC*)glfwGetProcAddress("glPopDebugGroup");
    glpfPushDebugGroup = (PFNGLPUSHDEBUGGROUP_PROC*)glfwGetProcAddress("glPushDebugGroup");
    glpfShaderStorageBlockBinding = (PFNGLSHADERSTORAGEBLOCKBINDING_PROC*)glfwGetProcAddress("glShaderStorageBlockBinding");
    glpfTexBufferRange = (PFNGLTEXBUFFERRANGE_PROC*)glfwGetProcAddress("glTexBufferRange");
    glpfTexStorage2DMultisample = (PFNGLTEXSTORAGE2DMULTISAMPLE_PROC*)glfwGetProcAddress("glTexStorage2DMultisample");
    glpfTexStorage3DMultisample = (PFNGLTEXSTORAGE3DMULTISAMPLE_PROC*)glfwGetProcAddress("glTexStorage3DMultisample");
    glpfTextureView = (PFNGLTEXTUREVIEW_PROC*)glfwGetProcAddress("glTextureView");
    glpfVertexAttribBinding = (PFNGLVERTEXATTRIBBINDING_PROC*)glfwGetProcAddress("glVertexAttribBinding");
    glpfVertexAttribFormat = (PFNGLVERTEXATTRIBFORMAT_PROC*)glfwGetProcAddress("glVertexAttribFormat");
    glpfVertexAttribIFormat = (PFNGLVERTEXATTRIBIFORMAT_PROC*)glfwGetProcAddress("glVertexAttribIFormat");
    glpfVertexAttribLFormat = (PFNGLVERTEXATTRIBLFORMAT_PROC*)glfwGetProcAddress("glVertexAttribLFormat");
    glpfVertexBindingDivisor = (PFNGLVERTEXBINDINGDIVISOR_PROC*)glfwGetProcAddress("glVertexBindingDivisor");

    /* GL_VERSION_4_4 */
    glpfBindBuffersBase = (PFNGLBINDBUFFERSBASE_PROC*)glfwGetProcAddress("glBindBuffersBase");
    glpfBindBuffersRange = (PFNGLBINDBUFFERSRANGE_PROC*)glfwGetProcAddress("glBindBuffersRange");
    glpfBindImageTextures = (PFNGLBINDIMAGETEXTURES_PROC*)glfwGetProcAddress("glBindImageTextures");
    glpfBindSamplers = (PFNGLBINDSAMPLERS_PROC*)glfwGetProcAddress("glBindSamplers");
    glpfBindTextures = (PFNGLBINDTEXTURES_PROC*)glfwGetProcAddress("glBindTextures");
    glpfBindVertexBuffers = (PFNGLBINDVERTEXBUFFERS_PROC*)glfwGetProcAddress("glBindVertexBuffers");
    glpfBufferStorage = (PFNGLBUFFERSTORAGE_PROC*)glfwGetProcAddress("glBufferStorage");
    glpfClearTexImage = (PFNGLCLEARTEXIMAGE_PROC*)glfwGetProcAddress("glClearTexImage");
    glpfClearTexSubImage = (PFNGLCLEARTEXSUBIMAGE_PROC*)glfwGetProcAddress("glClearTexSubImage");

    /* GL_VERSION_4_5 */
    glpfBindTextureUnit = (PFNGLBINDTEXTUREUNIT_PROC*)glfwGetProcAddress("glBindTextureUnit");
    glpfBlitNamedFramebuffer = (PFNGLBLITNAMEDFRAMEBUFFER_PROC*)glfwGetProcAddress("glBlitNamedFramebuffer");
    glpfCheckNamedFramebufferStatus = (PFNGLCHECKNAMEDFRAMEBUFFERSTATUS_PROC*)glfwGetProcAddress("glCheckNamedFramebufferStatus");
    glpfClearNamedBufferData = (PFNGLCLEARNAMEDBUFFERDATA_PROC*)glfwGetProcAddress("glClearNamedBufferData");
    glpfClearNamedBufferSubData = (PFNGLCLEARNAMEDBUFFERSUBDATA_PROC*)glfwGetProcAddress("glClearNamedBufferSubData");
    glpfClearNamedFramebufferfi = (PFNGLCLEARNAMEDFRAMEBUFFERFI_PROC*)glfwGetProcAddress("glClearNamedFramebufferfi");
    glpfClearNamedFramebufferfv = (PFNGLCLEARNAMEDFRAMEBUFFERFV_PROC*)glfwGetProcAddress("glClearNamedFramebufferfv");
    glpfClearNamedFramebufferiv = (PFNGLCLEARNAMEDFRAMEBUFFERIV_PROC*)glfwGetProcAddress("glClearNamedFramebufferiv");
    glpfClearNamedFramebufferuiv = (PFNGLCLEARNAMEDFRAMEBUFFERUIV_PROC*)glfwGetProcAddress("glClearNamedFramebufferuiv");
    glpfClipControl = (PFNGLCLIPCONTROL_PROC*)glfwGetProcAddress("glClipControl");
    glpfCompressedTextureSubImage1D = (PFNGLCOMPRESSEDTEXTURESUBIMAGE1D_PROC*)glfwGetProcAddress("glCompressedTextureSubImage1D");
    glpfCompressedTextureSubImage2D = (PFNGLCOMPRESSEDTEXTURESUBIMAGE2D_PROC*)glfwGetProcAddress("glCompressedTextureSubImage2D");
    glpfCompressedTextureSubImage3D = (PFNGLCOMPRESSEDTEXTURESUBIMAGE3D_PROC*)glfwGetProcAddress("glCompressedTextureSubImage3D");
    glpfCopyNamedBufferSubData = (PFNGLCOPYNAMEDBUFFERSUBDATA_PROC*)glfwGetProcAddress("glCopyNamedBufferSubData");
    glpfCopyTextureSubImage1D = (PFNGLCOPYTEXTURESUBIMAGE1D_PROC*)glfwGetProcAddress("glCopyTextureSubImage1D");
    glpfCopyTextureSubImage2D = (PFNGLCOPYTEXTURESUBIMAGE2D_PROC*)glfwGetProcAddress("glCopyTextureSubImage2D");
    glpfCopyTextureSubImage3D = (PFNGLCOPYTEXTURESUBIMAGE3D_PROC*)glfwGetProcAddress("glCopyTextureSubImage3D");
    glpfCreateBuffers = (PFNGLCREATEBUFFERS_PROC*)glfwGetProcAddress("glCreateBuffers");
    glpfCreateFramebuffers = (PFNGLCREATEFRAMEBUFFERS_PROC*)glfwGetProcAddress("glCreateFramebuffers");
    glpfCreateProgramPipelines = (PFNGLCREATEPROGRAMPIPELINES_PROC*)glfwGetProcAddress("glCreateProgramPipelines");
    glpfCreateQueries = (PFNGLCREATEQUERIES_PROC*)glfwGetProcAddress("glCreateQueries");
    glpfCreateRenderbuffers = (PFNGLCREATERENDERBUFFERS_PROC*)glfwGetProcAddress("glCreateRenderbuffers");
    glpfCreateSamplers = (PFNGLCREATESAMPLERS_PROC*)glfwGetProcAddress("glCreateSamplers");
    glpfCreateTextures = (PFNGLCREATETEXTURES_PROC*)glfwGetProcAddress("glCreateTextures");
    glpfCreateTransformFeedbacks = (PFNGLCREATETRANSFORMFEEDBACKS_PROC*)glfwGetProcAddress("glCreateTransformFeedbacks");
    glpfCreateVertexArrays = (PFNGLCREATEVERTEXARRAYS_PROC*)glfwGetProcAddress("glCreateVertexArrays");
    glpfDisableVertexArrayAttrib = (PFNGLDISABLEVERTEXARRAYATTRIB_PROC*)glfwGetProcAddress("glDisableVertexArrayAttrib");
    glpfEnableVertexArrayAttrib = (PFNGLENABLEVERTEXARRAYATTRIB_PROC*)glfwGetProcAddress("glEnableVertexArrayAttrib");
    glpfFlushMappedNamedBufferRange = (PFNGLFLUSHMAPPEDNAMEDBUFFERRANGE_PROC*)glfwGetProcAddress("glFlushMappedNamedBufferRange");
    glpfGenerateTextureMipmap = (PFNGLGENERATETEXTUREMIPMAP_PROC*)glfwGetProcAddress("glGenerateTextureMipmap");
    glpfGetCompressedTextureImage = (PFNGLGETCOMPRESSEDTEXTUREIMAGE_PROC*)glfwGetProcAddress("glGetCompressedTextureImage");
    glpfGetCompressedTextureSubImage = (PFNGLGETCOMPRESSEDTEXTURESUBIMAGE_PROC*)glfwGetProcAddress("glGetCompressedTextureSubImage");
    glpfGetGraphicsResetStatus = (PFNGLGETGRAPHICSRESETSTATUS_PROC*)glfwGetProcAddress("glGetGraphicsResetStatus");
    glpfGetNamedBufferParameteri64v = (PFNGLGETNAMEDBUFFERPARAMETERI64V_PROC*)glfwGetProcAddress("glGetNamedBufferParameteri64v");
    glpfGetNamedBufferParameteriv = (PFNGLGETNAMEDBUFFERPARAMETERIV_PROC*)glfwGetProcAddress("glGetNamedBufferParameteriv");
    glpfGetNamedBufferPointerv = (PFNGLGETNAMEDBUFFERPOINTERV_PROC*)glfwGetProcAddress("glGetNamedBufferPointerv");
    glpfGetNamedBufferSubData = (PFNGLGETNAMEDBUFFERSUBDATA_PROC*)glfwGetProcAddress("glGetNamedBufferSubData");
    glpfGetNamedFramebufferAttachmentParameteriv = (PFNGLGETNAMEDFRAMEBUFFERATTACHMENTPARAMETERIV_PROC*)glfwGetProcAddress("glGetNamedFramebufferAttachmentParameteriv");
    glpfGetNamedFramebufferParameteriv = (PFNGLGETNAMEDFRAMEBUFFERPARAMETERIV_PROC*)glfwGetProcAddress("glGetNamedFramebufferParameteriv");
    glpfGetNamedRenderbufferParameteriv = (PFNGLGETNAMEDRENDERBUFFERPARAMETERIV_PROC*)glfwGetProcAddress("glGetNamedRenderbufferParameteriv");
    glpfGetQueryBufferObjecti64v = (PFNGLGETQUERYBUFFEROBJECTI64V_PROC*)glfwGetProcAddress("glGetQueryBufferObjecti64v");
    glpfGetQueryBufferObjectiv = (PFNGLGETQUERYBUFFEROBJECTIV_PROC*)glfwGetProcAddress("glGetQueryBufferObjectiv");
    glpfGetQueryBufferObjectui64v = (PFNGLGETQUERYBUFFEROBJECTUI64V_PROC*)glfwGetProcAddress("glGetQueryBufferObjectui64v");
    glpfGetQueryBufferObjectuiv = (PFNGLGETQUERYBUFFEROBJECTUIV_PROC*)glfwGetProcAddress("glGetQueryBufferObjectuiv");
    glpfGetTextureImage = (PFNGLGETTEXTUREIMAGE_PROC*)glfwGetProcAddress("glGetTextureImage");
    glpfGetTextureLevelParameterfv = (PFNGLGETTEXTURELEVELPARAMETERFV_PROC*)glfwGetProcAddress("glGetTextureLevelParameterfv");
    glpfGetTextureLevelParameteriv = (PFNGLGETTEXTURELEVELPARAMETERIV_PROC*)glfwGetProcAddress("glGetTextureLevelParameteriv");
    glpfGetTextureParameterIiv = (PFNGLGETTEXTUREPARAMETERIIV_PROC*)glfwGetProcAddress("glGetTextureParameterIiv");
    glpfGetTextureParameterIuiv = (PFNGLGETTEXTUREPARAMETERIUIV_PROC*)glfwGetProcAddress("glGetTextureParameterIuiv");
    glpfGetTextureParameterfv = (PFNGLGETTEXTUREPARAMETERFV_PROC*)glfwGetProcAddress("glGetTextureParameterfv");
    glpfGetTextureParameteriv = (PFNGLGETTEXTUREPARAMETERIV_PROC*)glfwGetProcAddress("glGetTextureParameteriv");
    glpfGetTextureSubImage = (PFNGLGETTEXTURESUBIMAGE_PROC*)glfwGetProcAddress("glGetTextureSubImage");
    glpfGetTransformFeedbacki64_v = (PFNGLGETTRANSFORMFEEDBACKI64_V_PROC*)glfwGetProcAddress("glGetTransformFeedbacki64_v");
    glpfGetTransformFeedbacki_v = (PFNGLGETTRANSFORMFEEDBACKI_V_PROC*)glfwGetProcAddress("glGetTransformFeedbacki_v");
    glpfGetTransformFeedbackiv = (PFNGLGETTRANSFORMFEEDBACKIV_PROC*)glfwGetProcAddress("glGetTransformFeedbackiv");
    glpfGetVertexArrayIndexed64iv = (PFNGLGETVERTEXARRAYINDEXED64IV_PROC*)glfwGetProcAddress("glGetVertexArrayIndexed64iv");
    glpfGetVertexArrayIndexediv = (PFNGLGETVERTEXARRAYINDEXEDIV_PROC*)glfwGetProcAddress("glGetVertexArrayIndexediv");
    glpfGetVertexArrayiv = (PFNGLGETVERTEXARRAYIV_PROC*)glfwGetProcAddress("glGetVertexArrayiv");
    glpfGetnCompressedTexImage = (PFNGLGETNCOMPRESSEDTEXIMAGE_PROC*)glfwGetProcAddress("glGetnCompressedTexImage");
    glpfGetnTexImage = (PFNGLGETNTEXIMAGE_PROC*)glfwGetProcAddress("glGetnTexImage");
    glpfGetnUniformdv = (PFNGLGETNUNIFORMDV_PROC*)glfwGetProcAddress("glGetnUniformdv");
    glpfGetnUniformfv = (PFNGLGETNUNIFORMFV_PROC*)glfwGetProcAddress("glGetnUniformfv");
    glpfGetnUniformiv = (PFNGLGETNUNIFORMIV_PROC*)glfwGetProcAddress("glGetnUniformiv");
    glpfGetnUniformuiv = (PFNGLGETNUNIFORMUIV_PROC*)glfwGetProcAddress("glGetnUniformuiv");
    glpfInvalidateNamedFramebufferData = (PFNGLINVALIDATENAMEDFRAMEBUFFERDATA_PROC*)glfwGetProcAddress("glInvalidateNamedFramebufferData");
    glpfInvalidateNamedFramebufferSubData = (PFNGLINVALIDATENAMEDFRAMEBUFFERSUBDATA_PROC*)glfwGetProcAddress("glInvalidateNamedFramebufferSubData");
    glpfMapNamedBuffer = (PFNGLMAPNAMEDBUFFER_PROC*)glfwGetProcAddress("glMapNamedBuffer");
    glpfMapNamedBufferRange = (PFNGLMAPNAMEDBUFFERRANGE_PROC*)glfwGetProcAddress("glMapNamedBufferRange");
    glpfMemoryBarrierByRegion = (PFNGLMEMORYBARRIERBYREGION_PROC*)glfwGetProcAddress("glMemoryBarrierByRegion");
    glpfNamedBufferData = (PFNGLNAMEDBUFFERDATA_PROC*)glfwGetProcAddress("glNamedBufferData");
    glpfNamedBufferStorage = (PFNGLNAMEDBUFFERSTORAGE_PROC*)glfwGetProcAddress("glNamedBufferStorage");
    glpfNamedBufferSubData = (PFNGLNAMEDBUFFERSUBDATA_PROC*)glfwGetProcAddress("glNamedBufferSubData");
    glpfNamedFramebufferDrawBuffer = (PFNGLNAMEDFRAMEBUFFERDRAWBUFFER_PROC*)glfwGetProcAddress("glNamedFramebufferDrawBuffer");
    glpfNamedFramebufferDrawBuffers = (PFNGLNAMEDFRAMEBUFFERDRAWBUFFERS_PROC*)glfwGetProcAddress("glNamedFramebufferDrawBuffers");
    glpfNamedFramebufferParameteri = (PFNGLNAMEDFRAMEBUFFERPARAMETERI_PROC*)glfwGetProcAddress("glNamedFramebufferParameteri");
    glpfNamedFramebufferReadBuffer = (PFNGLNAMEDFRAMEBUFFERREADBUFFER_PROC*)glfwGetProcAddress("glNamedFramebufferReadBuffer");
    glpfNamedFramebufferRenderbuffer = (PFNGLNAMEDFRAMEBUFFERRENDERBUFFER_PROC*)glfwGetProcAddress("glNamedFramebufferRenderbuffer");
    glpfNamedFramebufferTexture = (PFNGLNAMEDFRAMEBUFFERTEXTURE_PROC*)glfwGetProcAddress("glNamedFramebufferTexture");
    glpfNamedFramebufferTextureLayer = (PFNGLNAMEDFRAMEBUFFERTEXTURELAYER_PROC*)glfwGetProcAddress("glNamedFramebufferTextureLayer");
    glpfNamedRenderbufferStorage = (PFNGLNAMEDRENDERBUFFERSTORAGE_PROC*)glfwGetProcAddress("glNamedRenderbufferStorage");
    glpfNamedRenderbufferStorageMultisample = (PFNGLNAMEDRENDERBUFFERSTORAGEMULTISAMPLE_PROC*)glfwGetProcAddress("glNamedRenderbufferStorageMultisample");
    glpfReadnPixels = (PFNGLREADNPIXELS_PROC*)glfwGetProcAddress("glReadnPixels");
    glpfTextureBarrier = (PFNGLTEXTUREBARRIER_PROC*)glfwGetProcAddress("glTextureBarrier");
    glpfTextureBuffer = (PFNGLTEXTUREBUFFER_PROC*)glfwGetProcAddress("glTextureBuffer");
    glpfTextureBufferRange = (PFNGLTEXTUREBUFFERRANGE_PROC*)glfwGetProcAddress("glTextureBufferRange");
    glpfTextureParameterIiv = (PFNGLTEXTUREPARAMETERIIV_PROC*)glfwGetProcAddress("glTextureParameterIiv");
    glpfTextureParameterIuiv = (PFNGLTEXTUREPARAMETERIUIV_PROC*)glfwGetProcAddress("glTextureParameterIuiv");
    glpfTextureParameterf = (PFNGLTEXTUREPARAMETERF_PROC*)glfwGetProcAddress("glTextureParameterf");
    glpfTextureParameterfv = (PFNGLTEXTUREPARAMETERFV_PROC*)glfwGetProcAddress("glTextureParameterfv");
    glpfTextureParameteri = (PFNGLTEXTUREPARAMETERI_PROC*)glfwGetProcAddress("glTextureParameteri");
    glpfTextureParameteriv = (PFNGLTEXTUREPARAMETERIV_PROC*)glfwGetProcAddress("glTextureParameteriv");
    glpfTextureStorage1D = (PFNGLTEXTURESTORAGE1D_PROC*)glfwGetProcAddress("glTextureStorage1D");
    glpfTextureStorage2D = (PFNGLTEXTURESTORAGE2D_PROC*)glfwGetProcAddress("glTextureStorage2D");
    glpfTextureStorage2DMultisample = (PFNGLTEXTURESTORAGE2DMULTISAMPLE_PROC*)glfwGetProcAddress("glTextureStorage2DMultisample");
    glpfTextureStorage3D = (PFNGLTEXTURESTORAGE3D_PROC*)glfwGetProcAddress("glTextureStorage3D");
    glpfTextureStorage3DMultisample = (PFNGLTEXTURESTORAGE3DMULTISAMPLE_PROC*)glfwGetProcAddress("glTextureStorage3DMultisample");
    glpfTextureSubImage1D = (PFNGLTEXTURESUBIMAGE1D_PROC*)glfwGetProcAddress("glTextureSubImage1D");
    glpfTextureSubImage2D = (PFNGLTEXTURESUBIMAGE2D_PROC*)glfwGetProcAddress("glTextureSubImage2D");
    glpfTextureSubImage3D = (PFNGLTEXTURESUBIMAGE3D_PROC*)glfwGetProcAddress("glTextureSubImage3D");
    glpfTransformFeedbackBufferBase = (PFNGLTRANSFORMFEEDBACKBUFFERBASE_PROC*)glfwGetProcAddress("glTransformFeedbackBufferBase");
    glpfTransformFeedbackBufferRange = (PFNGLTRANSFORMFEEDBACKBUFFERRANGE_PROC*)glfwGetProcAddress("glTransformFeedbackBufferRange");
    glpfUnmapNamedBuffer = (PFNGLUNMAPNAMEDBUFFER_PROC*)glfwGetProcAddress("glUnmapNamedBuffer");
    glpfVertexArrayAttribBinding = (PFNGLVERTEXARRAYATTRIBBINDING_PROC*)glfwGetProcAddress("glVertexArrayAttribBinding");
    glpfVertexArrayAttribFormat = (PFNGLVERTEXARRAYATTRIBFORMAT_PROC*)glfwGetProcAddress("glVertexArrayAttribFormat");
    glpfVertexArrayAttribIFormat = (PFNGLVERTEXARRAYATTRIBIFORMAT_PROC*)glfwGetProcAddress("glVertexArrayAttribIFormat");
    glpfVertexArrayAttribLFormat = (PFNGLVERTEXARRAYATTRIBLFORMAT_PROC*)glfwGetProcAddress("glVertexArrayAttribLFormat");
    glpfVertexArrayBindingDivisor = (PFNGLVERTEXARRAYBINDINGDIVISOR_PROC*)glfwGetProcAddress("glVertexArrayBindingDivisor");
    glpfVertexArrayElementBuffer = (PFNGLVERTEXARRAYELEMENTBUFFER_PROC*)glfwGetProcAddress("glVertexArrayElementBuffer");
    glpfVertexArrayVertexBuffer = (PFNGLVERTEXARRAYVERTEXBUFFER_PROC*)glfwGetProcAddress("glVertexArrayVertexBuffer");
    glpfVertexArrayVertexBuffers = (PFNGLVERTEXARRAYVERTEXBUFFERS_PROC*)glfwGetProcAddress("glVertexArrayVertexBuffers");
...
PFNGLGETCOMPRESSEDTEXTURESUBIMAGE_PROC* glpfGetCompressedTextureSubImage = NULL;
PFNGLGETGRAPHICSRESETSTATUS_PROC* glpfGetGraphicsResetStatus = NULL;
...
PFNGLGETTEXTURESUBIMAGE_PROC* glpfGetTextureSubImage = NULL;
...
PFNGLGETNCOMPRESSEDTEXIMAGE_PROC* glpfGetnCompressedTexImage = NULL;
PFNGLGETNTEXIMAGE_PROC* glpfGetnTexImage = NULL;
PFNGLGETNUNIFORMDV_PROC* glpfGetnUniformdv = NULL;
PFNGLGETNUNIFORMFV_PROC* glpfGetnUniformfv = NULL;
PFNGLGETNUNIFORMIV_PROC* glpfGetnUniformiv = NULL;
PFNGLGETNUNIFORMUIV_PROC* glpfGetnUniformuiv = NULL;
...
PFNGLMEMORYBARRIERBYREGION_PROC* glpfMemoryBarrierByRegion = NULL;
...
PFNGLREADNPIXELS_PROC* glpfReadnPixels = NULL;
PFNGLTEXTUREBARRIER_PROC* glpfTextureBarrier = NULL;
